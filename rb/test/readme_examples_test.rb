...
#      offline in seeded test mode (UToLinkShortenerSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UToLinkShortener_sdk.rb")
  SDK_CLASS = "UToLinkShortenerSDK"

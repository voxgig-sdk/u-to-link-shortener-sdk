// Command UToLinkShortener-mcp is an MCP server exposing the UToLinkShortener
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UToLinkShortener_list  — list records of an entity
//	UToLinkShortener_load  — load a single record of an entity
//

...
type Args struct {
	Entity string         `json:"entity" jsonschema:"link_shortening"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UToLinkShortenerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "u-to-link-shortener_list",
		Description: "List records from UToLinkShortener. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "u-to-link-shortener_load",
		Description: "Load a single record from UToLinkShortener. " +
...
func runOp(client *sdk.UToLinkShortenerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UToLinkShortenerSDK, name string) (sdk.UToLinkShortenerEntity, error) {
	switch strings.ToLower(name) {
	case "link_shortening":
		return client.LinkShortening(nil), nil

...
func registerSDKWords(r *eng.Registry, client *sdk.UToLinkShortenerSDK) {
...
func runOp(client *sdk.UToLinkShortenerSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

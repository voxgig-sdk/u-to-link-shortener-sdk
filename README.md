...
u.to Link Shortener client, generated from the OpenAPI spec.

The u.to API provides a simple and efficient way to shorten any URL into a concise link.

Learn more about u.to Link Shortener at [github.com/l0v3m0n3y/uto](https://github.com/l0v3m0n3y/uto).

This is an unofficial SDK for the u.to Link Shortener public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — LinkShortening — that you
...
const linkshortening = await client.LinkShortening().create({
  url: 'example',
})
```
...
// linkshortening is the LinkShortening entity, populated with mock data
...
```go
client := sdk.Test()
result, err := client.LinkShortening(nil).Create(
...
```bash
cd go-mcp && go build -o u-to-link-shortener-mcp .
```
...
```json
{
  "mcpServers": {
    "u-to-link-shortener": {
      "command": "/abs/path/to/u-to-link-shortener-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **LinkShortening** | The LinkShortening entity (create). | `/shorten/` |
...
```go
import sdk "github.com/voxgig-sdk/u-to-link-shortener-sdk/go"
...
- Upstream API: [https://github.com/l0v3m0n3y/uto](https://github.com/l0v3m0n3y/uto)
...
Generated from the u.to Link Shortener OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).

...
from utolinkshortener_sdk.utolinkshortener_types import (
    LinkShortening,
...
class LinkShorteningEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LinkShorteningEntity(self._client, opts)
    ...
    def data_get(self) -> LinkShortening:
    ...
    def match_get(self) -> LinkShortening:
    ...
    def create(self, reqdata: LinkShorteningCreateData, ctrl=None) -> LinkShortening:
        utility = self._utility

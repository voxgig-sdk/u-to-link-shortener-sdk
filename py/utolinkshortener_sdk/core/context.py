...
from utolinkshortener_sdk.core.helpers import get_ctx_prop, to_map
...
class UToLinkShortenerContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UToLinkShortenerControl()
        ...
        if isinstance(sp, UToLinkShortenerSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UToLinkShortenerResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UToLinkShortenerResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return UToLinkShortenerOperation({})
    ...
    def make_error(self, code, msg):
        return UToLinkShortenerError(code, msg, self)

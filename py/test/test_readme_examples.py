# UToLinkShortener SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UToLinkShortenerSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UToLinkShortenerSDK(...) and UToLinkShortenerSDK.test(...) become
#      UToLinkShortenerSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "utolinkshortener_sdk"
_SDK_CLASS = "UToLinkShortenerSDK"
...
_ENTITIES = {
    "LinkShortening": "link_shortening",
}

...
type LinkShorteningEntity struct {
	name    string
	client  *core.UToLinkShortenerSDK
...
func NewLinkShorteningEntity(client *core.UToLinkShortenerSDK, entopts map[string]any) *LinkShorteningEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LinkShorteningEntity) GetName() string { return e.name }
...
func (e *LinkShorteningEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LinkShorteningEntity) Deleted() bool {
	return e.deleted
}


func (e *LinkShorteningEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLinkShorteningEntity(e.client, opts)
}

func (e *LinkShorteningEntity) Data(args ...any) any {
...
func (e *LinkShorteningEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LinkShortening; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LinkShorteningEntity) DataTyped(data ...LinkShortening) LinkShortening {
	if len(data) > 0 {
		return typedFrom[LinkShortening](e.Data(asMap(data[0])))
	}
	return typedFrom[LinkShortening](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LinkShortening (all fields
// optional at the wire level).
func (e *LinkShorteningEntity) MatchTyped(match ...LinkShortening) LinkShortening {
	if len(match) > 0 {
		return typedFrom[LinkShortening](e.Match(asMap(match[0])))
	}
	return typedFrom[LinkShortening](e.Match())
}
...
func (e *LinkShorteningEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LinkShorteningEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LinkShorteningEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *LinkShorteningEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LinkShorteningCreateData and returns an LinkShortening. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LinkShorteningEntity) CreateTyped(reqdata LinkShorteningCreateData, ctrl map[string]any) (LinkShortening, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return LinkShortening{}, err
	}
	return typedFrom[LinkShortening](res), nil
}



func (e *LinkShorteningEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LinkShorteningEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LinkShorteningEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

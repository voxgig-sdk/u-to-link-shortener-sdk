...
// UToLinkShortener SDK utility: fetcher

class UToLinkShortenerFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UToLinkShortenerSDK/1.0)';
    ...
    public static function call(UToLinkShortenerContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// UToLinkShortener SDK utility: graphql
//
...
class UToLinkShortenerGraphql
{
    ...
    // equivalent.
    public static function body(UToLinkShortenerContext $ctx): mixed
    {
    ...
    public static function errors(UToLinkShortenerContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

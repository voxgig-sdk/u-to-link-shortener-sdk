...
// UToLinkShortener SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UToLinkShortenerSDK::test)
...
{
    private const SDK_CLASS = 'UToLinkShortenerSDK';
    ...
    private const SDK_BASE = 'utolinkshortener_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../utolinkshortener_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

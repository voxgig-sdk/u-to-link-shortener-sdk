...
// UToLinkShortener SDK ratelimit feature
...
class UToLinkShortenerRatelimitFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _acquire(UToLinkShortenerContext $ctx): void
    {
    ...
    private function _track(UToLinkShortenerContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
// UToLinkShortener SDK proxy feature
...
class UToLinkShortenerProxyFeature extends UToLinkShortenerBaseFeature
{
    ...
    public function init(UToLinkShortenerContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UToLinkShortenerContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

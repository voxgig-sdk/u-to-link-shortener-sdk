...
// UToLinkShortener SDK cache feature
...
class UToLinkShortenerCacheFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _through(UToLinkShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// UToLinkShortener SDK clienttrack feature
...
class UToLinkShortenerClienttrackFeature extends UToLinkShortenerBaseFeature
{
    ...
    public function PostConstruct(UToLinkShortenerContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UToLinkShortener-SDK';

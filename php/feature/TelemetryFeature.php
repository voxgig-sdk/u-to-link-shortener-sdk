...
// UToLinkShortener SDK telemetry feature
...
class UToLinkShortenerTelemetryFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _close(UToLinkShortenerContext $ctx, bool $ok): void
    {

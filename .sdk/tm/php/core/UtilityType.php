...
// UToLinkShortener SDK utility type

class UToLinkShortenerUtility
{
    ...
    public static function copy(UToLinkShortenerUtility $src): UToLinkShortenerUtility
    {
        $u = new UToLinkShortenerUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

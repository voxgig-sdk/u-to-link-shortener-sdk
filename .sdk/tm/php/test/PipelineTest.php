...
// UToLinkShortener SDK pipeline test
//
...
{
    private static function utility(): UToLinkShortenerUtility
    {
        return new UToLinkShortenerUtility();
    }
    ...
    private static function ctx(array $over = []): UToLinkShortenerContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UToLinkShortenerContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UToLinkShortenerOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UToLinkShortenerError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UToLinkShortenerOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UToLinkShortenerMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UToLinkShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UToLinkShortenerMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UToLinkShortenerOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UToLinkShortenerMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UToLinkShortenerSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UToLinkShortenerMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UToLinkShortenerResponse([]),
            'result' => new UToLinkShortenerResult([]),
        ]);
        [, $err] = UToLinkShortenerMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UToLinkShortenerSpec([]),
            'response' => null,
            'result' => new UToLinkShortenerResult([]),
        ]);
        [, $err] = UToLinkShortenerMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UToLinkShortenerSpec(['step' => 's']),
            'response' => new UToLinkShortenerResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UToLinkShortenerResult([]),
        ]);
        [, $err] = UToLinkShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UToLinkShortenerSpec(['step' => 's']),
            'response' => new UToLinkShortenerResponse(self::resp(200, ['v' => 1])),
            'result' => new UToLinkShortenerResult([]),
        ]);
        [, $err] = UToLinkShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UToLinkShortenerSpec(['step' => 's']),
            'response' => new UToLinkShortenerResponse(self::resp(200, ['v' => 2])),
            'result' => new UToLinkShortenerResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UToLinkShortenerMakeResponse::call($ctx);
    ...
    {
        $preset = new UToLinkShortenerResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UToLinkShortenerSpec([]),
            'response' => new UToLinkShortenerResponse([]),
            'result' => new UToLinkShortenerResult([]),
        ...
        [$got, $err] = UToLinkShortenerMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UToLinkShortenerResult([])]);
        [, $err] = UToLinkShortenerMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UToLinkShortenerSpec([]), 'result' => null]);
        [, $err] = UToLinkShortenerMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UToLinkShortenerSpec(['step' => 's']),
            'result' => new UToLinkShortenerResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UToLinkShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UToLinkShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UToLinkShortenerSpec(['step' => 's']),
            'result' => new UToLinkShortenerResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UToLinkShortenerOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UToLinkShortenerMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UToLinkShortenerResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UToLinkShortenerSpec([]),
            'result' => new UToLinkShortenerResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UToLinkShortenerMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UToLinkShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UToLinkShortenerError('boom', 'boom');
        $utility->fetcher = function (UToLinkShortenerContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UToLinkShortenerSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UToLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UToLinkShortenerContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UToLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UToLinkShortenerResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UToLinkShortenerMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UToLinkShortenerContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UToLinkShortenerSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UToLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UToLinkShortenerResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UToLinkShortenerSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UToLinkShortenerMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UToLinkShortenerMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UToLinkShortenerMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UToLinkShortenerResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UToLinkShortenerDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UToLinkShortenerResult(['ok' => false])]);
        $this->expectException(UToLinkShortenerError::class);
        UToLinkShortenerDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UToLinkShortenerResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UToLinkShortenerMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UToLinkShortenerMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UToLinkShortenerBaseFeature();
        $b = new UToLinkShortenerBaseFeature();
        UToLinkShortenerFeatureAdd::call($ctx, $a);
        UToLinkShortenerFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UToLinkShortenerBaseFeature
    {
        $f = new UToLinkShortenerBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UToLinkShortenerFeatureAdd::call($ctx, self::named_feature('a'));
        UToLinkShortenerFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        UToLinkShortenerFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        UToLinkShortenerFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        UToLinkShortenerFeatureAdd::call($ctx, $replace);
        ...
        UToLinkShortenerFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UToLinkShortenerContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UToLinkShortenerSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UToLinkShortenerPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UToLinkShortenerPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UToLinkShortenerResponse(['headers' => null]),
            'result' => new UToLinkShortenerResult([]),
        ]);
        UToLinkShortenerResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UToLinkShortenerResultBody::call($ctx);

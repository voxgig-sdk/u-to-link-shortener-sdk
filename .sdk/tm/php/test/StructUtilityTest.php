...
// UToLinkShortener SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UToLinkShortenerOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UToLinkShortenerOmni::structfix($now, Struct::undef()))
                        !== json_encode(UToLinkShortenerOmni::structfix($val, Struct::undef()))) {

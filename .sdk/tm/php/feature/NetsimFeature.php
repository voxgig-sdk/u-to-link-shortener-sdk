...
// UToLinkShortener SDK netsim feature
...
class UToLinkShortenerNetsimFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _simulate(UToLinkShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UToLinkShortenerContext $ctx, array $applied): void
    {
        $client = $this->client;

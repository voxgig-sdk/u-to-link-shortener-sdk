...
// UToLinkShortener SDK streaming feature
...
class UToLinkShortenerStreamingFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _iterate(UToLinkShortenerResult $result): \Generator
    {
    ...
    private function _streamable(UToLinkShortenerContext $ctx): bool
    {

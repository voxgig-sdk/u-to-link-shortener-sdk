...
// UToLinkShortener SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UToLinkShortenerTestFeature extends UToLinkShortenerBaseFeature
{
    ...
    public function init(UToLinkShortenerContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UToLinkShortenerContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UToLinkShortenerParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UToLinkShortenerContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UToLinkShortenerContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = UToLinkShortenerParam::call($ctx, $k);

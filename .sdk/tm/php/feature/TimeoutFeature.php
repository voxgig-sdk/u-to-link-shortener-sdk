...
// UToLinkShortener SDK timeout feature
...
class UToLinkShortenerTimeoutFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _with_timeout(UToLinkShortenerContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UToLinkShortenerContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
// UToLinkShortener SDK rbac feature
...
class UToLinkShortenerRbacFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _required(UToLinkShortenerContext $ctx): ?string
    {
    ...
    private function _reject(UToLinkShortenerContext $ctx, string $required): void
    {
    ...
    private function _track(UToLinkShortenerContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

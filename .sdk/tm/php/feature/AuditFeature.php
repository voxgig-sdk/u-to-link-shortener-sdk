...
// UToLinkShortener SDK audit feature
...
class UToLinkShortenerAuditFeature extends UToLinkShortenerBaseFeature
{
    ...
    private function _emit(UToLinkShortenerContext $ctx, string $outcome): void
    {

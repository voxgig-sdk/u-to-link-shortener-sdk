...
// UToLinkShortener SDK utility: result_basic

class UToLinkShortenerResultBasic
{
    public static function call(UToLinkShortenerContext $ctx): ?UToLinkShortenerResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof UToLinkShortenerError) ? $result->err->msg : (string)$result->err;

...
// UToLinkShortener SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UToLinkShortenerTransformResponse
{
    public static function call(UToLinkShortenerContext $ctx): mixed
    {
        ...
        $transform = UToLinkShortenerHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

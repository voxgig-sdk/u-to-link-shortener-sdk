...
// UToLinkShortener SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UToLinkShortenerMakeRequest
{
    public static function call(UToLinkShortenerContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UToLinkShortenerResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UToLinkShortenerResponse($fetched);
        } else {

...
class UToLinkShortenerTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UToLinkShortenerTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UToLinkShortenerTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UToLinkShortenerTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

...
|---|---|---|
| `ts/` | @voxgig-sdk/u-to-link-shortener-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/u-to-link-shortener-sdk \
      --repository voxgig-sdk/u-to-link-shortener-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/u-to-link-shortener-sdk` shows it, and
`npm trust revoke @voxgig-sdk/u-to-link-shortener-sdk --id=<id>` removes it.

...
function runner.env_override(m)
  local live = runner.getenv("UTOLINKSHORTENER_TEST_LIVE")
  local override = runner.getenv("UTOLINKSHORTENER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UTOLINKSHORTENER_TEST_EXPLAIN")

...
local function make_error_util(ctx, err)
  ...
  local msg = "UToLinkShortenerSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = UToLinkShortenerError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == UToLinkShortenerError then
